...
> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-remix-serverless)

- [Remix](https://remix.run/) app deployed serverlessly via the
  [remix-web resource](https://docs.stacktape.com/compute-resources/remix-web/) — Lambda + S3 + CloudFront CDN.
- Server-side rendered with nested routing and progressive enhancement. Pay only for traffic you serve.
...
```bash
stacktape init --starterId remix-serverless
```
...
The `remix-web` resource handles everything automatically:
